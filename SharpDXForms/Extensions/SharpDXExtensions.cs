...
namespace SharpDXForms
{
	public static class SharpDXExtensions
	{
		...
		{
			if( rectangle.Right < r.Left )
			{
				return false;
			}
			if( rectangle.Left > r.Right )
			{
				return false;
			}
			if( rectangle.Bottom < r.Top )
			{
				return false;
			}
			if( rectangle.Top > r.Bottom )
			{
				return false;
			}
			return true;
		...
		#region Point
		public static Vector2 ToVector( this System.Drawing.Point p )
		{
		...
		public static Size2 ToSize2( this Point p )
		{
			return new Size2( p.X, p.Y );
		}

		public static Size2F ToSize2F( this Point p )
		{
			return new Size2F( p.X, p.Y );
		}
		#endregion
		...
		public static Size2F ToSize2F( this Vector2 v )
		{
			return new Size2F( v.X, v.Y );
		}
		...
		#region Size
		public static Vector2 ToVector( this System.Drawing.Size s )
		{
			return new Vector2( s.Width, s.Height );
		}

		public static Vector2 ToVector( this Size2 s )
		{
			return new Vector2( s.Width, s.Height );
		}

		public static Vector2 ToVector( this Size2F s )
		{
			return new Vector2( s.Width, s.Height );
		}

		public static Point ToPoint( this Size2 s )
		{
			return new Point( s.Width, s.Height );
		}

		public static Point ToPoint( this Size2F s )
		{
			return new Point( (int)s.Width, (int)s.Height );
		}
		#endregion
